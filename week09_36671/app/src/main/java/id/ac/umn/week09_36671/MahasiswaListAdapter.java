...
public class MahasiswaListAdapter extends RecyclerView.Adapter<MahasiswaListAdapter.MahasiswaViewHolder> {
    ...
    private List<id.ac.umn.week09_36671.Mahasiswa> daftarMahasiswa;
    ...
    public void onBindViewHolder(@NonNull MahasiswaViewHolder holder, int position) {
        if(daftarMahasiswa != null){
            id.ac.umn.week09_36671.Mahasiswa mhs = daftarMahasiswa.get(position);
    ...
    public id.ac.umn.week09_36671.Mahasiswa getMahasiswaAtPosition(int posisi){
        return daftarMahasiswa.get(posisi);
    }
    void setDaftarMahasiswa(List<id.ac.umn.week09_36671.Mahasiswa> mhss){
