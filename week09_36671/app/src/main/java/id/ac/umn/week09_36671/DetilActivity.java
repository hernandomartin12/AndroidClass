...
public class DetilActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(intent.hasExtra("MAHASISWA")) {
            id.ac.umn.week09_36671.Mahasiswa mhs = (id.ac.umn.week09_36671.Mahasiswa)
    ...
    public void simpanData(View view){
        ...
        if(mNIM.length() <= 0 || mNama.length() <= 0 ||
            ...
            id.ac.umn.week09_36671.Mahasiswa mhs = new id.ac.umn.week09_36671.Mahasiswa(mNIM, mNama, mEmail, mNoHp);
